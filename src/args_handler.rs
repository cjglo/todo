...
impl ArgsHandler {
    ...
    pub fn new(args_count: usize, args: &Vec<String>) -> ArgsHandler {
        let mut handler = ArgsHandler { help_flag: false, delete_flag_and_index: None, marker_flag_and_index: None, change_flag_and_index: None, is_invalid_or_blank: false, args_count };
